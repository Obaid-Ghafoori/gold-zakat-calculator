...
const ZakatCalculatorPage = () => {
  ...
  return (
    <>
      <NavBar/>
      <div className="container flex flex-col items-center justify-center text-center px-4 sm:px-6 lg:px-8">
        {/* <h1 className="text-center text-2xl sm:text-3xl md:text-4xl lg:text-5xl mt-4 mb-2">Zakat Calculator</h1> */}
        <p>
